...
const sampleMessagesDataArray: TMessagesData[] = [
  {
    ...
    messageInParas: [
      "Hey there Mathur, it's your birthday! Wishing you the happiest of birthdays filled with all the things you love and cherish the most.",
      "May this year be filled with lots of laughter, love, and unforgettable memories. I hope you get to spend your special day surrounded by me ofcourse,huhhhhhh...and doing nothing bcz that make you happy.",
      "Whether it's a mid day power nap k naam p sleep ya pucchhhi break, I hope you have the best time ever. last but not the least Here's year of being awesome, slaying the game",
      "You're a true gem, vamps, and I feel lucky to have you. Happy birthday and cheers to a fantastic year ahead!",
    ],
  ...
  },
  {
    ...
    messageInParas: [
      ...
      "Once again, happy birthday, kuschelbar! Cheers to the year of laughter, love, and wonderful memories together...",
    ],
